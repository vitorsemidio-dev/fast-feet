...
import { ChangeOrderStatusToDeliveredController } from '@/infra/http/controllers/change-order-status-to-delivered.controller'
...
@Module({
  ...
  controllers: [
    ...
    ChangeOrderStatusToDeliveredController,
  ],
  providers: [
    AuthenticateUseCase,
